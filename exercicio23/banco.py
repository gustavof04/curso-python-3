...
if __name__ == '__main__':
    c1 = pessoas.Cliente('João', 30)
    cc1 = contas.ContaCorrente("001", "123456", 0, 100)
    c1.conta = cc1
    c2 = pessoas.Cliente('Maria', 29)
    cp1 = contas.ContaPoupanca("002", "654321", 100)
    c2.conta = cp1
    banco = Banco()
    banco.clientes.extend([c1, c2])
    banco.contas.extend([cc1, cp1])
    banco.agencias.extend(["001", "002"])

    if banco.autenticar(c1, cc1):
        cc1.depositar(10)
        c1.conta.depositar(110)
        c1.conta.sacar(20)
        print(c1.conta)
